...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vehicles', '0018_auto_20151002_2316'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ret_status_da', models.CharField(default=b'PE', max_length=2, verbose_name=b'Retry Status', choices=[(b'PE', b'Pending'), (b'ST', b'Started'), (b'RU', b'Running'), (b'AB', b'Aborted'), (b'SU', b'Success'), (b'FA', b'Failed'), (b'WA', b'Waiting'), (b'RE', b'Rejected'), (b'TD', b'Terminated')])),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('upd_status_da', models.CharField(default=b'PE', max_length=2, verbose_name=b'Update Status', choices=[(b'PE', b'Pending'), (b'ST', b'Started'), (b'RU', b'Running'), (b'AB', b'Aborted'), (b'SU', b'Success'), (b'FA', b'Failed'), (b'WA', b'Waiting'), (b'RE', b'Rejected'), (b'TD', b'Terminated')])),
                ('upd_expiration', models.DateTimeField(verbose_name=b'Valid Until')),
